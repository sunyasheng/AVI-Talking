    ...
    def __init__(self, config):
        ...
        if config.model.backbone == "resnet50":
            ...
            if config.model.load_pretrained:
                ...
                config.model.pretrained_weights = '/data/yashengsun/Proj/TalkingFace/InstructedFFTalker/BlendshapeVisualizer/EMOCA/assets/FaceRecognition/resnet50_ft_weight.pkl'
