...
def decode(emoca, values, training=False):
    # angry_exp_path = 'out_angry_level_3_001_000080/EMOCA_v2_lr_mse_20/00008000/exp.npy'
    # angry_shape_path = 'out_angry_level_3_001_000080/EMOCA_v2_lr_mse_20/00008000/shape.npy'
    # angry_exp = np.load(angry_exp_path)
    # angry_shape = np.load(angry_shape_path)
    #
    # change_exp, change_shape = True, False
    # if change_exp is True:
    #     values['expcode'][0] = torch.from_numpy(angry_exp).cuda()
    # if change_shape is True:
    #     values['shapecode'][0] = torch.from_numpy(angry_shape).cuda()
