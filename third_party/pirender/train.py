...
def parse_args():
    ...
    parser.add_argument('--dataset_names', type=str, default='Mead_M,Mead_W,tfhd')
    parser.add_argument('--is_only_emo', type=int, default=0)
...
if __name__ == '__main__':
    ...
    # print(opt.name, opt.data.train.batch_size)
    print('num_workers: ', opt.data.num_workers)
