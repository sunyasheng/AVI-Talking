...
def read_data(args):
        ...
        for f in tqdm(fs):
            if f.endswith("wav"):
                ...
                if not os.path.exists(vertice_path):
                    ...
                    if args.dataset == 'yuwei_ffm':
                        data[key]["vertice"] = np.load(vertice_path,allow_pickle=True) #due to the memory limit
    ...
    splits = {'vocaset':{'train':range(1,41),'val':range(21,41),'test':range(21,41)},
              ...
              'yuwei_ffm':{'train':range(0,20),'val':range(21,22),'test':range(21,22)}}

    for k, v in data.items():
        subject_id = "_".join(k.split("_")[:-1])
        sentence_id = int(k.split(".")[0][-2:])
        # print(subject_id, sentence_id)
...
if __name__ == "__main__":
    ...
    args.template_file = 'templates.pkl'
    args.wav_path = 'wav'
    # args.vertices_path = 'vertices_npy'
    # args.train_subjects = 'FaceTalk_170728_03272_TA'
    # args.val_subjects = 'FaceTalk_170811_03275_TA'
    # args.test_subjects = 'FaceTalk_170809_00138_TA'

    args.dataset = 'yuwei_ffm'
    args.vertices_path = 'vertices_npy_om'
    args.train_subjects = 'shortvideo'
    args.val_subjects = 'shortvideo'
    args.test_subjects = 'shortvideo'
